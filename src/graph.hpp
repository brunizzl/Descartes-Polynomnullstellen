...
public:
	...
	void add_polynomial(const polynomial::Monomials& p, const SVG::Style& style = svg_style::blue_line);
	void add_polynomial(const polynomial::Bernstein& p, const SVG::Style& style = svg_style::blue_line);
